...
//二元运算符基类
function BinaryExpression(left, right, operator, line) {
  Node.call(this, {"left": left, "right": right}, {"operator": operator}, line);
}
...
//一元运算符基类
function UnaryExpression(node, operator,line) {
  Node.call(this, {"node": node}, {"operator": operator}, line);
}
